...
return [
  ...
  'coverage-notice-end' => 'en POST en envoyant, en json, un tableau d\'objets qui indiquent l\'id des Pokémons choisis en clé et leur capacité (sans accents et avec des - au lieu des espaces) (mettre une châine de caractères vide, null ou false si pas de capacité pour le Pokémon). Exemple : [
                                                                                                                              {3: null},
                                                                                                                              {110: "Levitation"},
                                                                                                                              {6: ""},
                                                                                                                              {292: "Garde-Mystik}"
  ...
  'suggestion-notice-end' => 'en POST en envoyant, en json, un tableau d\'objets qui indiquent l\'id des Pokémons choisis en clé et leur capacité (sans accents et avec des - au lieu des espaces) (mettre une châine de caractères vide, null ou false si pas de capacité pour le Pokémon). Exemple : [
                                                                                                                                {3: null},
                                                                                                                                {110: "Levitation"},
                                                                                                                                {6: ""},
                                                                                                                                {292: "Garde-Mystik}"
