 ...
 */
final class Version20210309092626 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE resistance_modifying_abilities (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, multiplier DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
